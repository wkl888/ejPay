...
# ejPay个人收款支付系统
[![AUR](https://img.shields.io/aur/license/yaourt.svg)](https://github.com/Exrick/ejPay/blob/master/License)
[![](https://img.shields.io/badge/Author-Exrick-orange.svg)](http://blog.exrick.cn)
[![](https://img.shields.io/badge/version-1.1-brightgreen.svg)](https://github.com/Exrick/ejPay)
[![GitHub stars](https://img.shields.io/github/stars/Exrick/ejPay.svg?style=social&label=Stars)](https://github.com/Exrick/ejPay)
[![GitHub forks](https://img.shields.io/github/forks/Exrick/ejPay.svg?style=social&label=Fork)](https://github.com/Exrick/ejPay)
> 作者大四作品 期待您的捐赠支持！
...
### v1.9版本已发布！实现移动端支付方案 [立即获取源码和文档](http://ejPay.exrick.cn/pay)
...
- 轻松支持多账户收款 赶快使用手机扫码体验吧
    ...
    ![](http://ejPay.exrick.cn/assets/images/mobiletest.png)

#### 注：v1.9源码（含原理及详细文档）获取方式 
- 进入 [ejPay官网](http://ejPay.exrick.cn/pay) 成功支付测试后 将自动发至你所填写的邮箱中
...
- Payjs （疑似使用[微信小微商户](https://pay.weixin.qq.com/index.php/core/affiliate/micro_intro)，是否稳定可靠有待观察）
    - `微信个人免签接口，正规业务推荐使用`
    - 结论：仅支持微信、不免费、费率高
...
- 如何确定收款来自哪笔交易订单？
    ...
    - v1.2版本起已解决该问问题 [点我获取最新版本源码](http://ejPay.exrick.cn/pay)
- 为什么不做自动监听？
...
- 微信小程序APP 
    - [前台源码点我提前获取](http://ejPay.exrick.cn/pay) [预览视频](https://v.qq.com/x/page/f0627kf4x1e.html)
